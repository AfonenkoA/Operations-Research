...
Создать документ `Quarto Markdown` в RStudio @sec-enviroment-rstudio-quarto-project или через командную строку @sec-enviroment-quarto. Отчёт загружается на образовательный портал.
