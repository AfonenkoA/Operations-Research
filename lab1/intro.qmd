# Лабораторная работа 1. Введение {#sec-lab1}

::: {.callout-caution title="Состояние разработки"}
Требуется доработка
:::

## Инструкции {#sec-lab1-instructions}
...
4.  Скачать пример интерактивного блокнот Quarto @sec-enviroment-quarto-example-install и сохранить его в отдельном каталоге (например `lab1` ).
5.  Скопировать в рабочий каталог файлы [окружения renv](https://github.com/AfonenkoA/Operations-Research/tree/renv) и восстановить пакеты @sec-r-tools-renv-project-restore
6.  Отрендерить пример @sec-enviroment-quarto-preview или @sec-enviroment-rstudio-quarto-document
...
## Задания {#sec-lab1-task}

### Отчёт

Создать документ `Quarto` в RStudio @sec-enviroment-rstudio-quarto-project или через командную строку @sec-enviroment-quarto. Отчёт загружается на образовательный портал.

### Язык программирования R {#sec-lab1-task-r-programming}

:::: {#exr-lab1-r-lang-vector-seq}
...
:::: {#exr-lab1-r-lang-plot2d}
Построить график (@sec-r-tools-plotly-line2d) кусочно-гладкой функции (@sec-r-lang-basic-function-defenition) используя функцию [ifelse](https://rdrr.io/r/base/ifelse.html)
...
:::: {#exr-lab1-r-lang-sum-vectorization}
...
Использовав по максимуму векторные (@sec-r-lang-basic-vectorization) операции рассчитайте для различных $n$ от $n=10$ до $n=10^{10}$
...
### Линейная алгебра {#sec-lab1-task-linear-algebra}

:::: {#exr-lab1-linear-algebra-equation-solve-integrated}
...
:::: {#exr-lab1-linear-algebra-formula-check}
...
:::: {#exr-lab1-linear-algebra-equation-solve-custom-gauss}
...
### Исследование операций {#sec-lab1-task-operations-research}

:::: {#exr-lab1-operations-research-graphical-solution}
...
:::: {#exr-lab1-operations-research-moving-body}
...
:::: {#exr-lab1-operations-research-ship}
...
:::: {#exr-lab1-operations-research-box}
...
### Прикладная магия {#sec-lab1-task-magic}

:::: {#exr-lab1-magic}
Пусть дана функция общего вида $f(x,y)$ и система уравнений $Ax=b$ для двух переменных. Постройте контурный график функции, на котором изобразите точки пересечения прямых. Обработать случая параллельных прямых, совпадающих прямых. @sec-r-lang-advanced-formula
