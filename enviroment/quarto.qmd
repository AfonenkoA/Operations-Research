...
1.  скачать пример файла `.qmd` [`example.qmd`](https://github.com/AfonenkoA/Operations-Research/tree/master/enviroment/example.qmd)
...
Если пакет `tidyverse` устанавливается с ошибками см. @sec-lab1-instructions пункт `renv`
