...
plot_ly(x=x, y=y, z = z, type = "surface") |>
  add_trace(x=1, y=-2, z = 0, type='scatter3d', mode='markers', name='M0',  marker = list(size = 10, color = "red", symbol = 104))
```
...
#| message: false
#| echo: false
#| fig-cap: "Гиперболический параболоид"
...
plot_ly(x=x, y=y, z = z, type = "surface") |>
  add_trace(x=0, y=0, z = 0, type='scatter3d', mode='markers', name='M0', marker = list(size = 10, color = "red", symbol = 104))
```
...
plot_ly(x=x, y=y, z = z, type = "surface") |>
  add_trace(x=0, y=1, z = -2, type='scatter3d', mode='markers', name='M0', marker = list(size = 10, color = "red", symbol = 104))
```

##### Решение

на первом шаге нужно отыскать стационарные точки. Для этого найдём частные производные 1-го порядка:
...
Таким образом $AC-B^2=6\cdot 4-1^2=23>0$, следовательно в точке $M_0$ есть экстремум, и так как $A>0$, то это минимум.
