...
Реализовать решение системы линейных уравнений методом гаусса @sec-linear-algebra-equation-system-many-variables-alghorythm-gauss используя векторные операции.
