# Лабораторная работа 1. Введение {#sec-lab-1}
...
4.  Создать пример интерактивного блокнот Quarto @sec-enviroment-quarto-example-install и сохранить его в отдельном каталоге (например `lab1` ).
...
::: {.callout-note appearance="minimal" title="Уровень 1"}
:::
::::
...
::: {.callout-note appearance="minimal" title="Уровень 2"}
:::
::::
...
::: {.callout-note appearance="minimal" title="Уровень 3"}
:::
::::
...
::: {.callout-note appearance="minimal" title="Уровень 4"}
:::

Дополнительно попробуйте использовать встроенный интерфейса формулы используя переменно число аргументов для функции. Считайте символ `~` эквивалентом символу `=`.
