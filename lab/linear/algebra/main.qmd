...
# Линейная алгебра {#sec-lab-linear-algebra}

## Теория

1.  Повторить отдельные элементы из линейной алгебры @sec-linear-algebra

## Задания {#sec-lab-task}

::::: {#exr-lab-linear-algebra-equation-solve-integrated}
### СЛАУ
...
`{r} solve() |> dl()` @sec-r-tools-basic-solve
...
::::: {#exr-lab-linear-algebra-formula-check}
### Ого, формулки!
...
:::: {#exr-lab-linear-algebra-equation-solve-custom-gauss}
### Всё решено
