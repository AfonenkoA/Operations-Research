...
# Транспортные модели {#sec-lab-linear-transport}

## Задачи

:::::: {#exr-lab-linear-transport-failed-exam}
### Несчастливая сессия
...
:::::: {#exr-lab-linear-transport-distribution}
...
::::: {#exr-lab-linear-transport-organizations}
### Задача Янукович
...
::: callout-tip
Для измерения производительности используйте `{r} system.time() |> dl()`
:::
:::::

::::::::::::: {#exr-lab-linear-transport-summer-work}
### Задача Людчика
...
::: {.callout appearance="minimal"}
`\faFile*[regular].`{=latex} [organizations.csv](lab/linear/transport/organizations.csv)
:::
::::
...
q |> as.data.frame() |> dplyr::select(1:5) |> head()
```
