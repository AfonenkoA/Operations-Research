...
Задать seed random одинаковый для всех итераций В эволюционном из хелпа по функциям определить факторы влияющие на решение. Изменяя факторы получить правильное решение с наименьшим числом итераций
