...
-   @sec-nonlinear-unconstrained-numerical-one
-   @sec-nonlinear-unconstrained-numerical-many-direct
-   @sec-nonlinear-unconstrained-numerical-many-gradient
...
Решить задачу @exr-lab-alghoritm-nonlinear-constrained используя барьерные функции @sec-nonlinear-constrained-numerical-convert-to-unconstrained-penalty.
