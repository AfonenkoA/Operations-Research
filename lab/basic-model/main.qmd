# Модели исследования операций {#sec-lab-basic-model}

## Теория

1.  Изучить язык разметки `LaTeX` @sec-latex
2.  Повторить теорию определения экстремумов функций @sec-nonlinear-unconstrained-one и @sec-nonlinear-unconstrained-many

::: {#exm-lab-basic-model-beach}
...
::::: {#exr-lab-basic-model-graphical-solution}
### Вспоминая АГИЛу
...
объемный (@sec-r-tools-plotly-surface3d), контурный (@sec-r-tools-plotly-contour2d) \#### Python
:::
...
:::: {#exr-lab-basic-model-moving-body}
### Брось!
