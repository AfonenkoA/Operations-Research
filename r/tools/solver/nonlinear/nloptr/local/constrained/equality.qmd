...
## Градиентные {#exm-r-tools-solver-nonlinear-nloptr-local-constrained-equality-gradient}

### SSQLP {#exm-r-tools-solver-nonlinear-nloptr-local-constrained-equality-gradient-ssqlp}
