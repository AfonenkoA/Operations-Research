...
Ограничения задаются в виде матрицы коэффициентов $\mathbf{A}$. Пакет может работать с общей формулировкой задачи @sec-linear-overview, поэтому приведение к стандартной форме не требуется
