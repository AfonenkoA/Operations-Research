...
## Одномерная оптимизация `optimize` {#sec-r-tools-stats-optimize}
...
## T-тест Стьюдента {#sec-r-tools-stats-ttest}

Равенства средних значений двух выборок
...
## F-тест {#sec-r-tools-stats-ftest}

Равенства средних для множества выборок
