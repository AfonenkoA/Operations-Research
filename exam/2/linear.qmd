...
::::: {.content-hidden unless-meta="convert-to-linear.select"}
:::: {#exr-exam-2-convert-to-linear}
## Линейная модель
...
::: {.content-visible when-profile="exam" layout-ncol="2"}
![](graphical-sensetivity-grid.svg){fig-align="center" width="7cm"}

![](graphical-sensetivity-grid.svg){fig-align="center" width="7cm"} <!-- Растянуть масштаб до 700 на 700 -->
:::
...
![](simplex-alghorytm-grid.svg){fig-align="right" width="6cm"}
:::
