...
{{< meta table-lamp.select >}}

::: {.content-hidden unsless-profile="practice"}
# Практическая работа: Модели исследования операций
:::
...
::::: {.content-hidden unless-meta="avia-tickets.select"}
:::: {#exr-practice-1-avia-tickets}
## Авиа-билеты
...
:::: {.content-hidden when-profile="practice"}
::: {#sol-practice-1-avia-tickets}
{{< lipsum 2 >}}
:::
::::

::::: {.content-hidden unless-meta="table-lamp.select"}
:::: {#exr-practice-1-table-lamp}
## Стол и лампа
